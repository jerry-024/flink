 ...
 */
public class SubtaskAllExecutionAttemptDetailsHeaders implements MessageHeaders<EmptyRequestBody, SubtaskExecutionAttemptsDetailsInfo, SubtaskMessageParameters> {
	...
	@Override
	public Class<SubtaskExecutionAttemptsDetailsInfo> getResponseClass() {
