...
import org.apache.flink.runtime.rest.messages.job.SubtaskExecutionAttemptsDetailsInfo;
 ...
 */
public class SubtaskAllExecutionAttemptsDetailsHandler extends AbstractSubtaskHandler<SubtaskExecutionAttemptsDetailsInfo, SubtaskMessageParameters> {
	...
	public SubtaskAllExecutionAttemptsDetailsHandler(
		...
		MessageHeaders<EmptyRequestBody, SubtaskExecutionAttemptsDetailsInfo, SubtaskMessageParameters> messageHeaders,
	...
	@Override
	protected SubtaskExecutionAttemptsDetailsInfo handleRequest(
	...
	@VisibleForTesting
	public SubtaskExecutionAttemptsDetailsInfo createSubtaskExecutionAttemptsDetailsInfo(AccessExecutionVertex executionVertex, JobID jobID, JobVertexID jobVertexID) {
		...
		return new SubtaskExecutionAttemptsDetailsInfo(allAttempts);
	}
}
