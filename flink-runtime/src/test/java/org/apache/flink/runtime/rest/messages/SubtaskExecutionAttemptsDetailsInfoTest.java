...
/**
 * Tests for (un)marshalling of {@link SubtaskExecutionAttemptsDetailsInfo}.
 */
public class SubtaskExecutionAttemptsDetailsInfoTest extends RestResponseMarshallingTestBase {
	@Override
	protected Class getTestResponseClass() {
		return SubtaskExecutionAttemptsDetailsInfo.class;
	}
	...
	protected ResponseBody getTestResponseInstance() throws Exception {
		...
		subtaskExecutionAttemptDetailsInfoList.add(new SubtaskExecutionAttemptDetailsInfo(
			...
			jobVertexMetrics,
			taskmanagerId));
		return new SubtaskExecutionAttemptsDetailsInfo(subtaskExecutionAttemptDetailsInfoList);
	}
}
