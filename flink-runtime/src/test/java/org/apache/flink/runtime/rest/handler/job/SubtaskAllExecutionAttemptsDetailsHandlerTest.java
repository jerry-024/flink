...
public class SubtaskAllExecutionAttemptsDetailsHandlerTest extends TestLogger {
	...
	public static void setUpClass() throws HandlerRequestException {
		HashMap<String, String> receivedPathParameters = new HashMap<>(2);
	...
	public void testHandleRequest() throws Exception {
		ArchivedExecutionVertex executionVertex = createExecutionVertex();
		final SubtaskExecutionAttemptsDetailsInfo detailsInfo = handler.handleRequest(testRequest, executionVertex);
		SubtaskExecutionAttemptsDetailsInfo expectedDetailsInfo = handler.createSubtaskExecutionAttemptsDetailsInfo(executionVertex, JOBID, JOB_VERTEXID);
		assertEquals(detailsInfo, expectedDetailsInfo);
	}

	private ArchivedExecutionVertex createExecutionVertex() {
